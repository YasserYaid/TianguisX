...
class ProductsAdapter(context : Context, productList : MutableList<Product>, seller : Seller?, buyer : Buyer?) : BaseAdapter() {
...
//    var currentBuyer = buyer
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        productRowDetailsBTN?.setOnClickListener{
            ...
            goToShowProductDetails(currentProduct)
        }

        return myConvertView!!
    }

    fun goToShowProductDetails(product : Product?){
        val intent = Intent(context, ShowProductDetailsActivity::class.java)
